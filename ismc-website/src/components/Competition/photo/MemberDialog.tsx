...
export function PhotoMemberDialog({ member }: { member: PhotoMember }) {
  ...
  // --- Styles ---
  const inputClass = "bg-black/20 border-white/10 text-slate-200 placeholder:text-slate-500 focus-visible:ring-pink-500/50"; // Pink accent for Photo
