import { getHackathonData } from "@/actions/server/admin_hackathon";
import { HackDataTable } from "@/components/admin/HackDataTable";
      ...
      <div className="max-w-[1400px] mx-auto space-y-8">
        ...
        <div className="flex flex-col gap-4 border-b border-zinc-800 pb-6">
          ...
          <div className="flex justify-between items-end">
            <div>
              <h1 className="text-3xl font-bold text-white">Hackathon</h1>
